...
// Pin Definitions
#define OLED128X64_PIN_RST	6
#define OLED128X64_PIN_DC	5
#define OLED128X64_PIN_CS	4
#define PUSHBUTTON_PIN_2	7
#define ROTARYENCODEREN11_INT_PIN_A	2
#define ROTARYENCODEREN11_INT_PIN_B	3
#define ROTARYENCODEREN11_INT_PIN_SW	8
...
void loop() 
{
    ...
    {
    // Disclaimer: The Rotary Encoder is in testing and/or doesn't have code, therefore it may be buggy. Please be kind and report any bugs you may find.
    }
...
char menu()
{
    ...
    Serial.println(F("(3) Rotary Encoder"));
    ...
    while (Serial.available()) 
    {
        ...
        {   
            ...
            if(c == '1') 
    			...
    			Serial.println(F("Now Testing Rotary Encoder - note that this component doesn't have a test code"));
            else
            {
